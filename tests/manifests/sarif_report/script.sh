...
SOOS_BRANCH_NAME="SARIFReport"        # ENTER BRANCH NAME HERE IF KNOWN
...
# OPTIONAL ARGS:
WORKSPACE="./manifests/sarif_report" #PUT YOUR REPO PATH HERE
...
SOOS_CHECKOUT_DIR="${PWD}/manifests/sarif_report"
