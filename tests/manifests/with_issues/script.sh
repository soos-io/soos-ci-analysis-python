...
SOOS_PROJECT_NAME="Unit Test Run And Wait with Issues"
...
# OPTIONAL ARGS:
WORKSPACE="./manifests/with_issues" #PUT YOUR REPO PATH HERE
...
SOOS_CHECKOUT_DIR="${PWD}/manifests/with_issues"
