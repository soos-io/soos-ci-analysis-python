...
SOOS_BRANCH_NAME="NoIssues"                # ENTER BRANCH NAME HERE IF KNOWN
...
# OPTIONAL ARGS:
WORKSPACE="./manifests/no_issues" #PUT YOUR REPO PATH HERE
...
SOOS_CHECKOUT_DIR="${PWD}/manifests/no_issues"
